...
class Input:
    ...
    def _handle_backspace(self) -> None:
        ...
        if self._cursor > 0:
            ...
            self._value = (
                self._value[: self._cursor - length] + self._value[self._cursor :]
            )
            self._cursor -= length
    ...
    def _handle_forward_delete(self) -> None:
        ...
        if self._cursor < len(self._value):
            ...
            self._value = (
                self._value[: self._cursor] + self._value[self._cursor + length :]
            )
    ...
    def render(self, width: int) -> list[str]:
        ...
        if total_width < available:
            ...
            cursor_col = visible_width(
                value[:cursor]
            )  # Use visible_width for cursor position
            ...
            if scroll_width > 0:
                ...
                before_cursor = slice_by_column(
                    value, start_col, max(0, cursor_col - start_col), True
                )
